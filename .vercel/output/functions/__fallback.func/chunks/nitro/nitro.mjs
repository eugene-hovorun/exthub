...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "c6b10aaa-f35e-480b-a077-033d6e14dd2f",
...
const _jPIIafvTpV9JMjNOzpMcZdDwxPYmQ48m7iGEG0woAo = defineNitroPlugin(async (nitroApp) => {
...
const _9XiLbTyMgQ1RtgKBk5EEjC_Q7s2XdGnc1vLbyyRL4 = (function(nitro) {
...
const plugins = [
  _jPIIafvTpV9JMjNOzpMcZdDwxPYmQ48m7iGEG0woAo,
_9XiLbTyMgQ1RtgKBk5EEjC_Q7s2XdGnc1vLbyyRL4
];
...
const _gT511R = defineCachedEventHandler(async (event) => {
...
const _TqJwpE = eventHandler(async (e) => {
...
const _CL0wXC = defineEventHandler(async (e) => {
...
const _B1deax = defineEventHandler(sitemapXmlEventHandler);

const _lazy_iyQWxb = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_iyQWxb, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _gT511R, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _TqJwpE, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _CL0wXC, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _B1deax, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_iyQWxb, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, withoutTrailingSlash as A, sanitizeStatusCode as B, baseURL as C, createHooks as D, executeAsync as E, listener as F, getResponseStatus as a, buildAssetsURL as b, getQuery as c, defineRenderHandler as d, createError$1 as e, destr as f, getResponseStatusText as g, getRouteRules as h, useNitroApp as i, joinURL as j, defu as k, klona as l, parseQuery as m, defuFn as n, hasProtocol as o, publicAssetsURL as p, parseURL as q, encodePath as r, serialize$1 as s, decodePath as t, useRuntimeConfig as u, isEqual as v, withQuery as w, isScriptProtocol as x, getContext as y, withTrailingSlash as z };
