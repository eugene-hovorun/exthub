import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { mergeProps, unref, createVNode, resolveDynamicComponent, computed, withCtx, renderSlot, useSlots, ref, inject, openBlock, createBlock, createCommentVNode, toDisplayString, toRef, defineComponent, shallowRef, h, resolveComponent, hasInjectionContext, toValue, watch, isRef, onServerPrefetch, provide, useModel, createTextVNode, mergeModels, getCurrentInstance, nextTick, createElementBlock, cloneVNode, defineAsyncComponent, useSSRContext, Suspense, Fragment, createApp, renderList, useId, shallowReactive, onErrorCaptured, reactive, effectScope, useTemplateRef, withModifiers, toHandlers, getCurrentScope, markRaw, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { s as serialize, k as defu, l as klona, m as parseQuery, n as defuFn, o as hasProtocol, j as joinURL, q as parseURL, r as encodePath, t as decodePath, v as isEqual, w as withQuery, x as isScriptProtocol, y as getContext, z as withTrailingSlash, A as withoutTrailingSlash, B as sanitizeStatusCode, e as createError$1, $ as $fetch$1, C as baseURL, D as createHooks, E as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-cOFtRGS3.mjs')
  },
  {
    name: "locatex",
    path: "/locatex",
    component: () => import('./index-D4T5CnUZ.mjs')
  },
  {
    name: "devpulse",
    path: "/devpulse",
    component: () => import('./index-BPrkRa1E.mjs')
  },
  {
    name: "locatex-policy",
    path: "/locatex/policy",
    component: () => import('./policy-BbPXJtuM.mjs')
  },
  {
    name: "devpulse-policy",
    path: "/devpulse/policy",
    component: () => import('./policy-m99nc0KV.mjs')
  },
  {
    name: "formforge",
    path: "/formforge",
    component: () => import('./index-DcBz0Y6d.mjs')
  },
  {
    name: "formforge-policy",
    path: "/formforge/policy",
    component: () => import('./policy-Cn43gfKh.mjs')
  },
  {
    name: "pickperfect",
    path: "/pickperfect",
    component: () => import('./index-CV_Wu5FW.mjs')
  },
  {
    name: "pickperfect-policy",
    path: "/pickperfect/policy",
    component: () => import('./policy-Be2OkSOr.mjs')
  }
];
...
const __nuxt_component_0 = Object.assign(_sfc_main$c, { __name: "UApp" });
const theme$7 = {
...
const _sfc_main$b = {
  ...
  setup(__props) {
    const props = __props;
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$7), ...appConfig2.ui?.container || {} }));
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: __props.as,
...
const _sfc_main$a = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$6), ...appConfig2.ui?.slideover || {} })({
...
const _sfc_main$9 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$5), ...appConfig2.ui?.modal || {} })({
      transition: props.transition,
...
const _sfc_main$8 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$4), ...appConfig2.ui?.drawer || {} })({
...
const _sfc_main$7 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$3), ...appConfig2.ui?.header || {} })());
    const Menu = computed(() => ({
...
const extensions = [
  {
    ...
    description: "Inspect live elements, generate stable selectors, validate them instantly, and build reusable locator templates faster.",
    to: "/locatex",
    screenshotCount: 4,
  ...
  },
  {
    ...
    description: "Pick colors from anywhere on your screen, map them to Tailwind, and extract clean palettes in seconds.",
    to: "/pickperfect",
    screenshotCount: 4,
  ...
  },
  {
    ...
    icon: "i-lucide-gauge",
    description: "Real-time performance overlay for developers. Watch FPS, memory, long tasks, and vitals without leaving the page.",
    to: "/devpulse",
    screenshotCount: 3,
  ...
  },
  {
    ...
    description: "One-click realistic fake data for any form, with smart detection, custom profiles, and locale-aware generation.",
    to: "/formforge",
    screenshotCount: 3,
...
const _sfc_main$2 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const liveToolsLabel = `${extensions.length} live tools`;
    useHead({
      meta: [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UApp, mergeProps({ class: "app-shell" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UHeader, { class: "border-b border-white/70 bg-white/70 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/70" }, {
              left: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_NuxtLink, {
                    to: "/",
                    class: "flex items-center gap-3 rounded-xl transition-transform duration-200 hover:scale-[1.01]"
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="flex size-10 items-center justify-center rounded-xl border border-white/70 bg-white/90 text-primary shadow-lg shadow-primary/10 dark:border-white/10 dark:bg-slate-900/80"${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_UIcon, {
                          name: "i-lucide-puzzle",
                          class: "size-5"
                        }, null, _parent4, _scopeId3));
                        _push4(`</span><span class="min-w-0"${_scopeId3}><span class="font-display text-lg font-bold text-slate-950 dark:text-white"${_scopeId3}><span class="text-primary"${_scopeId3}>Ext</span>Hub </span><span class="hidden text-xs text-slate-500 dark:text-slate-400 sm:block"${_scopeId3}> Chrome extension lab </span></span>`);
                      } else {
                        return [
                          createVNode("span", { class: "flex size-10 items-center justify-center rounded-xl border border-white/70 bg-white/90 text-primary shadow-lg shadow-primary/10 dark:border-white/10 dark:bg-slate-900/80" }, [
                          ...
                          createVNode("span", { class: "min-w-0" }, [
                            createVNode("span", { class: "font-display text-lg font-bold text-slate-950 dark:text-white" }, [
                              createVNode("span", { class: "text-primary" }, "Ext"),
                              createTextVNode("Hub ")
                            ]),
                            createVNode("span", { class: "hidden text-xs text-slate-500 dark:text-slate-400 sm:block" }, " Chrome extension lab ")
                          ])
                        ];
                      }
                    }),
              ...
              right: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center gap-2 sm:gap-3"${_scopeId2}><span class="hidden rounded-xl border border-white/70 bg-white/80 px-4 py-1 text-xs font-medium text-slate-600 dark:border-white/10 dark:bg-slate-900/75 dark:text-slate-300 md:inline-flex"${_scopeId2}>${ssrInterpolate(liveToolsLabel)}</span>`);
                  _push3(ssrRenderComponent(_component_UColorModeButton, { class: "button-icon-20 rounded-lg border border-white/70 bg-white/80 shadow-sm dark:border-white/10 dark:bg-slate-900/75" }, null, _parent3, _scopeId2));
                  _push3(`</div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex items-center gap-2 sm:gap-3" }, [
                      createVNode("span", { class: "hidden rounded-xl border border-white/70 bg-white/80 px-4 py-1 text-xs font-medium text-slate-600 dark:border-white/10 dark:bg-slate-900/75 dark:text-slate-300 md:inline-flex" }, toDisplayString(liveToolsLabel)),
                      createVNode(_component_UColorModeButton, { class: "button-icon-20 rounded-lg border border-white/70 bg-white/80 shadow-sm dark:border-white/10 dark:bg-slate-900/75" })
                    ])
                  ];
                }
              }),
            ...
            _push2(ssrRenderComponent(_component_UMain, { class: "relative" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_USeparator, { class: "opacity-60" }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_UFooter, { class: "border-t border-white/70 bg-white/45 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/45" }, {
              left: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="space-y-1"${_scopeId2}><p class="text-sm font-medium text-slate-700 dark:text-slate-200"${_scopeId2}> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} ExtHub </p><p class="text-xs text-slate-500 dark:text-slate-400"${_scopeId2}> Focused browser tools for developers and designers. </p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "space-y-1" }, [
                      createVNode("p", { class: "text-sm font-medium text-slate-700 dark:text-slate-200" }, " © " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " ExtHub ", 1),
                      createVNode("p", { class: "text-xs text-slate-500 dark:text-slate-400" }, " Focused browser tools for developers and designers. ")
                    ])
                  ];
                }
              }),
              right: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center gap-2"${_scopeId2}><span class="hidden text-xs text-slate-500 dark:text-slate-400 sm:inline"${_scopeId2}> Privacy-first. One-time upgrades. </span>`);
                  _push3(ssrRenderComponent(_component_UButton, {
                    ...
                    variant: "ghost",
                    size: "sm",
                    class: "button-icon-20 rounded-lg"
                  }, null, _parent3, _scopeId2));
                  _push3(`</div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex items-center gap-2" }, [
                      createVNode("span", { class: "hidden text-xs text-slate-500 dark:text-slate-400 sm:inline" }, " Privacy-first. One-time upgrades. "),
            ...
            return [
              createVNode(_component_UHeader, { class: "border-b border-white/70 bg-white/70 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/70" }, {
                left: withCtx(() => [
                  createVNode(_component_NuxtLink, {
                    to: "/",
                    class: "flex items-center gap-3 rounded-xl transition-transform duration-200 hover:scale-[1.01]"
              ...
              createVNode(_component_USeparator, { class: "opacity-60" }),
              createVNode(_component_UFooter, { class: "border-t border-white/70 bg-white/45 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/45" }, {
                left: withCtx(() => [
                  createVNode("div", { class: "space-y-1" }, [
                    createVNode("p", { class: "text-sm font-medium text-slate-700 dark:text-slate-200" }, " © " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " ExtHub ", 1),
                    createVNode("p", { class: "text-xs text-slate-500 dark:text-slate-400" }, " Focused browser tools for developers and designers. ")
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-S6KQ_buI.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DeTwnQG8.mjs'));
...
export { __nuxt_component_0$2 as _, _sfc_main$m as a, useSeoMeta as b, _sfc_main$b as c, _sfc_main$h as d, entry_default as default, extensions as e, useLocale as f, useAppConfig as g, get as h, tv as t, useHead as u };
